...
function createStructure(done) {
    ...
    const files = ["src/index.html", "src/script.js"];
...
exports.publish   = gulp.series(cleanAssets, publishHtml, publishJS,  publishFonts, publishImages);
